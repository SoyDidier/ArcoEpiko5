...
var collision = Matter.SAT.collides(ComputerArcher.body, playerArrows[i].body);
if (collision.collided && !playerArrows[i].isBroken){
...
function handleComputerArrowCollision() {
  ...
  var collision = Matter.SAT.collides(PlayerArcher.body, computerArrows[i].body);
  if (collision.collided && !computerArrows[i].isBroken){
    playerArcherLife  = -1;
  }
}
